...
// Definisi model PetaniUsers
const PetaniUsers = db.define(
  "petaniusers", // Nama tabel di database
  {
    uuid: {
      type: DataTypes.STRING, // Tipe data string
      defaultValue: () => `PTN-${generateRandomString(6)}`, // Menggunakan fungsi untuk menambahkan 'PTN-' diikuti oleh string acak
...
// Mengekspor model PetaniUsers agar bisa digunakan di bagian lain dari aplikasi
export default PetaniUsers;
